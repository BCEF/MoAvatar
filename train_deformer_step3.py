    ...
    for cycle in range(max_cycles):
        ...
        for batch_idx in range(num_batches+1):
            ...
            if gaussians.vertex_deformer is None or gaussians.temp_flame_vertices is None:
                # codedict={}
                # codedict['deformer_path'] = scene.getTrainCameras(dataset.resolution)[0].deformer_path
            ...
            for iteration in range(batch_start_iter, batch_end_iter + 1):
                ...
                prev_xyt_t,prev_rotation_t,prev_scaling_t = gaussians.forward(codedict=prev_codedict)
                current_dict={
